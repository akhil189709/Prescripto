            ...
            {docSlots.length > 0 &&
              docSlots.map((item, index) => (
                <div
                  ...
                  className={`text-center py-4 min-w-16 rounded-xl cursor-pointer border-sm transition-all ${
                    slotIndex === index
                      ? "bg-[#5f6fff] text-white rounded-full"
          ...
          {docSlots.length > 0 &&
            ...
            docSlots[slotIndex].map((item, index) => (
              <p
                ...
                key={index}
                className={`text-sm font-light flex-shrink-0 px-5 py-2 rounded-full cursor-pointer bg-gray-200 hover:bg-gray-300 transition ${
                  item.time === slotTime
